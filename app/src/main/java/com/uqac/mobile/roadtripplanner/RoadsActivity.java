...
public class RoadsActivity extends AppCompatActivity implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getDirection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new FetchURL(RoadsActivity.this).execute(getUrl(place1.getPosition(), place2.getPosition(), "driving"), "driving");
            }
        });
